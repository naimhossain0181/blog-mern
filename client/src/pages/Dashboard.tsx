...
const Dashboard = () => {
    ...
    return (
        <section>
            <div className=' flex  gap-2 w-full h-[83vh] justify-between '>
                <div className='nav w-[20%] h-full overflow-scroll scrollbar-hide'>
                    ...
                    <div className='option  flex flex-col justify-between items-center gap-4 bg-slate-400'>
